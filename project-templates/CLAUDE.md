# CLAUDE.md — [PROJECT NAME] (thin forwarder)
...
- `SESSION_NOTES.md` (this project) — Layer 3, rolling log
- `DECISIONS.md` (this project) — Layer 4, decision history

The `SessionStart` hook in `~/.claude/settings.json` lists all layers in read order. Follow it.
